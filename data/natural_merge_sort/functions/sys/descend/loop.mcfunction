...
execute if score $Value1 _ >= $Value2 _ run function natural_merge_sort:sys/descend/take1
execute if score $Value2 _ >= $Value1 _ run function natural_merge_sort:sys/descend/take2
