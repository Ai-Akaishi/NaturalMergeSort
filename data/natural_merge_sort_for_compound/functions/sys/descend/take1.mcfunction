...
execute store result score $Value1 _ run data get storage natural_merge_sort_for_compound: ListAsc[-1][-1].weight
execute unless data storage natural_merge_sort_for_compound: ListAsc[-1][-1] run scoreboard players set $Value1 _ -2147483648
